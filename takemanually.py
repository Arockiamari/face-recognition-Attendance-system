    ...
    def fill_attendance():
        ...
        if subb == "":
            ...
            def create_csv():
                df = pd.DataFrame(d)
                csv_name = (
                    "C:\\Users\\kalai\\PycharmProjects\\Attendance-Management-system-using-face-recognition\\Attendance(Manually)\\"
                    + subb
                    + "_"
                    + Date
                    + "_"
            ...
            def attf():
                ...
                subprocess.Popen(
                    r'explorer /select,"C:/Users/kalai/PycharmProjects/Attendance-Management-system-using-face-recognition/Attendance(Manually)"'
                )
